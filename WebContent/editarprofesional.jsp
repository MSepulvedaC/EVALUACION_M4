        ...
        <form action="Guardarprofesional" method="post">
            <ul>
             ...
             <li>
                ...
                <input  class="form" type="text"  id="runpro" name="runpro">
             </li>
             <br>
            <li>
                <label for="nombrepro">Nombres Profesional</label>
                <input  class="form" type="text" id="nombrepro" name="nombrepro">
            </li>
            <br>
            <li>
                <label for="apellidospro">Apellidos Profesional</label>
                <input  class="form" type="text" id="apellidospro" name="apellidospro">
            </li>
            <br>
            <li>
                <label for="telefonopro">Telefono Profesional</label>
                <input  class="form" type="text"  id="Telefonopro" name="telefonopro">
            </li>
            <br>
            <li>
                <label for="titulopro">Titulo Profesional</label>
                <input  class="form" type="text"  id="titulopro" name="titulopro">
            </li>
            <br>
            <li>
                <label for="Proyecto">Proyecto que desempeña</label>
                <input  class="form" type="text"  id="proyecto" name="proyecto">
            </li>
			</ul>
            <br>
            <br>
