...
<body>
        ...
        <form action="guardarusuario" method="post">
            ...
            <li>
                ...
                <input class="form" type="text" id="ingreso_nombres"" name="ingreso_nombres" required>
            </li>
            <br>
            <li>
                <label for="apellidos">Apellidos: </label>
                <input class="form" type="text" id="ingreso_apellidos" name="ingreso_apellidos" required>
            </li>
            <br>
            <li>
                <label for="Fecha naciemiento">Fecha de Nacimiento: </label>
                <input class="form" type="date"  id="ingreso_fechanac" name="ingreso_fechanac" required>
            </li>
            <br>
            <li>
                <label for="run">RUN (solo numeros): </label>
                <input class="form" type="text"  id="ingreso_run" name="ingreso_run" required>
            </li>
            <br>
            <li>
                <label for="type">Tipo de usuario: </label>
                <select class="form"style="margin-left: 50px;" name="combo" required>
